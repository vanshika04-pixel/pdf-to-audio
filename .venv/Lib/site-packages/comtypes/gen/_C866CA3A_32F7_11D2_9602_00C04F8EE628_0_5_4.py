...
__all__ = [
    'SpeechRecoEvents', 'SpeechTokenContext',
    'DISPID_SAFSetWaveFormatEx', 'SVP_21', 'DISPID_SVAlertBoundary',
    'SPVOICESTATUS', 'DISPID_SRRSpeakAudio', 'SpUnCompressedLexicon',
    'SDA_Two_Trailing_Spaces', 'DISPID_SPPEngineConfidence',
    'ISpeechPhraseElements', 'ISpRecognizer', 'DISPID_SRRPhraseInfo',
    'DISPID_SGRsFindRule', 'ISpeechLexiconWords',
    'DISPID_SRAudioInputStream', 'DISPID_SRGCmdSetRuleIdState',
    'SpeechRetainedAudioOptions', 'DISPID_SRCVoicePurgeEvent',
    'SVP_17', 'SDTPronunciation', 'SAFT12kHz16BitStereo',
    'DISPID_SPRules_NewEnum', 'DISPIDSPTSI_ActiveLength',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SVSFVoiceMask',
    'SAFT16kHz8BitStereo', 'DISPID_SOTCreateInstance',
    'DISPID_SVEStreamEnd', 'DISPID_SpeechPhraseProperty',
    'SPWF_INPUT', 'SVSFNLPSpeakPunc', 'SPRST_INACTIVE',
    'DISPID_SRRSaveToMemory', 'DISPID_SGRAttributes',
    'SVSFPurgeBeforeSpeak', 'SPPS_LMA',
    'SpeechGrammarTagUnlimitedDictation', 'ISpShortcut',
    'ISpRecoCategory', 'DISPID_SpeechPhoneConverter',
    'SAFTCCITT_ALaw_11kHzStereo', 'SP_VISEME_21',
    'DISPID_SRCERequestUI', 'eLEXTYPE_PRIVATE13', 'SFTSREngine',
    'SPEI_MIN_SR', 'SpeechUserTraining', 'SAFT44kHz8BitMono',
    'SP_VISEME_1', 'DISPID_SPPId', 'DISPID_SRIsShared',
    'ISpeechWaveFormatEx', 'DISPID_SpeechDataKey',
    'DISPID_SOTCGetDataKey', 'DISPID_SRCRequestedUIType',
    'SpNullPhoneConverter', 'SpeechInterference', 'SLODynamic',
    'SAFT22kHz8BitMono', 'SDTAll', 'ISpAudio',
    'DISPID_SDKGetlongValue', 'SREAllEvents',
    'DISPID_SRCCreateGrammar', 'ISpeechObjectToken',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SAFT48kHz8BitMono',
    'DISPID_SPCLangId', 'STCInprocHandler', 'DISPID_SPRuleChildren',
    'STSF_FlagCreate', 'SpeechCategoryAppLexicons', 'SVSFIsFilename',
    'DISPID_SVVoice', 'SGLexicalNoSpecialChars',
    'ISpeechXMLRecoResult', 'SVP_15', 'SPAS_PAUSE', 'ISpStreamFormat',
    'ISpeechPhraseElement', 'eLEXTYPE_PRIVATE5',
    'DISPID_SDKEnumValues', 'SVP_12', 'ISpeechAudioFormat',
    'DISPID_SVSpeak', 'DISPID_SPEsItem', 'DISPID_SPPParent',
    'SSTTWildcard', 'SpStream', 'DISPIDSPTSI_SelectionOffset',
    'SVSFlagsAsync', 'DISPID_SVEAudioLevel', 'ISpeechGrammarRule',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SGRName',
    'DISPID_SpeechLexiconProns', 'ISpeechCustomStream',
    'ISpeechRecoResultTimes', 'SVP_6', 'SPSModifier',
    'DISPID_SRCResume', 'SpeechRecognizerState',
    'DISPID_SRGSetWordSequenceData', 'SPFM_NUM_MODES',
    'SpeechRuleAttributes', 'SpPhoneticAlphabetConverter',
    'SpeechGrammarWordType', 'DISPID_SDKDeleteValue', 'SPEVENT',
    'DISPID_SpeechFileStream', 'SDA_One_Trailing_Space',
    'DISPID_SVAudioOutputStream', 'DISPID_SRRecognizer',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPAUDIOBUFFERINFO',
    'DISPID_SpeechObjectTokens', 'SRSActiveAlways',
    'SAFTADPCM_22kHzStereo', 'DISPID_SVSLastBookmarkId',
    'SPSHORTCUTPAIRLIST', 'SVP_20', 'SPPHRASEELEMENT',
    'DISPID_SPRuleFirstElement', 'ISpeechAudioStatus',
    'SAFT16kHz16BitStereo', 'SPRST_ACTIVE', 'ISpeechRecognizer',
    'SITooSlow', 'DISPID_SVGetProfiles', 'SP_VISEME_8', 'SRSEDone',
    'SpeechSpecialTransitionType', 'SpeechRegistryUserRoot',
    'SWPUnknownWordPronounceable', 'SPWORDPRONOUNCEABLE',
    'SRTEmulated', 'DISPID_SpeechLexiconWord', 'SWTDeleted',
    'eLEXTYPE_PRIVATE15', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SPRsItem', 'DISPID_SVWaitUntilDone', 'ISpeechDataKey',
    'SPDKL_CurrentConfig', 'DISPID_SGRsAdd', 'DISPID_SGRSTsCount',
    'ISpeechRecoResult2', 'eLEXTYPE_PRIVATE12', 'DISPID_SPIStartTime',
    'SP_VISEME_14', 'SPEI_SR_AUDIO_LEVEL', 'SPINTERFERENCE_NOISE',
    'DISPID_SAFGuid', 'SRAORetainAudio', 'SRATopLevel',
    'DISPID_SLRemovePronunciation', 'SPINTERFERENCE_TOOLOUD',
    'SPGS_ENABLED', 'SP_VISEME_9', 'DISPID_SVEViseme', 'ISpVoice',
    'DISPID_SLGenerationId', 'SREPropertyStringChange',
    'DISPID_SpeechPhraseRule', 'DISPID_SASetState',
    'DISPID_SVEPhoneme', 'SPEI_HYPOTHESIS',
    'DISPID_SpeechPhraseAlternates', 'SPEI_RESERVED1',
    'DISPID_SOTSetId', 'DISPID_SDKSetStringValue', 'SECFIgnoreCase',
    'DISPID_SPAPhraseInfo', 'SpAudioFormat',
    'SpeechCategoryRecognizers', 'DISPID_SGRId',
    'SAFT24kHz16BitStereo', 'SPRULESTATE', 'SPWORDPRONUNCIATIONLIST',
    'SPPS_Function', 'DISPID_SOTGetAttribute', 'SpeechAddRemoveWord',
    'SPGRAMMARSTATE', 'Speech_Default_Weight', 'ISpeechRecoGrammar',
    'ISpPhoneticAlphabetSelection', 'DISPID_SGRSTText',
    'SPSInterjection', 'ISpeechLexicon', 'eLEXTYPE_PRIVATE14',
    'DISPID_SVEBookmark', 'eLEXTYPE_USER', 'SVP_10',
    'SAFTADPCM_11kHzStereo', 'DISPID_SLWPronunciations',
    'SGPronounciation', 'ISpeechObjectTokenCategory',
    'SPPS_RESERVED1', 'DISPID_SpeechLexiconWords',
    'DISPID_SRCRetainedAudio', 'SPWT_DISPLAY', 'DISPID_SVGetVoices',
    'SPPS_RESERVED4', 'DISPID_SVSRunningState',
    'SpeechTokenKeyAttributes', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPPS_Modifier', 'DISPID_SVGetAudioInputs', 'SAFTGSM610_8kHzMono',
    'DISPID_SGRsItem', 'SP_VISEME_20', 'DISPID_SOTGetStorageFileName',
    'DISPID_SGRsCommitAndSave', 'DISPID_SRCState', 'SpVoice',
    'DISPID_SRRDiscardResultInfo', 'SREFalseRecognition',
    'SpSharedRecognizer', 'SpeechFormatType', 'SRTExtendableParse',
    'SSTTTextBuffer', 'eLEXTYPE_PRIVATE11', 'ISpeechObjectTokens',
    'SVEEndInputStream', 'SRADefaultToActive',
    'DISPID_SPRuleEngineConfidence', 'SPVPRI_ALERT',
    'SPDKL_CurrentUser', 'DISPID_SGRSTPropertyName', 'SASRun',
    'DISPID_SRRAlternates', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SLWsCount', 'DISPID_SGRAddState', 'DISPID_SMSAMMHandle',
    'DISPID_SPIElements', 'SAFT12kHz16BitMono', 'DISPID_SPEsCount',
    'DISPID_SRGIsPronounceable', 'SPFM_OPEN_READONLY',
    'SPWORDPRONUNCIATION', 'DISPID_SRRTTickCount', 'DISPID_SPAsCount',
    'SPEI_SR_RETAINEDAUDIO', 'SPEI_RESERVED5', 'SASPause',
    'DISPID_SAEventHandle', 'ISpDataKey',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SVSpeakCompleteEvent',
    'SPAR_High', 'SDTAudio', 'SREStreamEnd', 'ISpEventSource',
    'SAFTCCITT_ALaw_8kHzStereo', 'SVEPhoneme',
    'SAFTExtendedAudioFormat', 'SAFTCCITT_uLaw_11kHzMono',
    'ISpeechAudioBufferInfo', 'SPINTERFERENCE_NOSIGNAL',
    'eLEXTYPE_RESERVED4', 'STSF_LocalAppData', 'SVSFParseSsml',
    'eLEXTYPE_PRIVATE1', 'DISPID_SPRuleConfidence',
    'ISpPhoneConverter', 'DISPID_SRRGetXMLResult', 'SPSHORTCUTPAIR',
    'DISPID_SABufferNotifySize', 'SPXRO_Alternates_SML',
    'SAFTCCITT_ALaw_8kHzMono', 'ISpGrammarBuilder', 'SP_VISEME_16',
    'ISpeechPhraseRules', 'DISPID_SPEDisplayAttributes',
    'ISpObjectToken', 'DISPID_SpeechVoiceStatus', 'SPPS_Unknown',
    'SGDSActiveUserDelimited', 'SAFTCCITT_ALaw_11kHzMono',
    'SPEI_SENTENCE_BOUNDARY', 'SpeechAudioVolume',
    'SpeechMicTraining', 'DISPID_SOTCEnumerateTokens',
    'SpeechGrammarTagWildcard', 'IEnumString', 'SPSMF_UPS',
    'DISPID_SPELexicalForm', 'SPEI_SR_BOOKMARK', 'SECFDefault',
    'SPPS_Interjection', 'DISPID_SRRSetTextFeedback', 'SVSFParseSapi',
    'SpeechRecoProfileProperties', 'SPAUDIOOPTIONS',
    'SpObjectTokenCategory', 'SECNormalConfidence',
    'ISpeechTextSelectionInformation', 'SRCS_Enabled', 'SRADynamic',
    'ISpObjectTokenCategory', 'SP_VISEME_7', 'SAFT24kHz8BitStereo',
    'SPVPRI_NORMAL', 'SAFT44kHz8BitStereo', 'SpCompressedLexicon',
    'SPSSuppressWord', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SABIEventBias', 'SVEStartInputStream',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SLGetPronunciations',
    'STCLocalServer', 'DISPID_SpeechVoiceEvent', 'SAFTDefault',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SPCPhoneToId',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPPsItem',
    'SpeechDisplayAttributes', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SRRTStreamTime', 'ISpeechPhoneConverter',
    'DISPID_SRGRules', 'SVESentenceBoundary',
    'DISPID_SpeechPhraseReplacement', 'SPSTREAMFORMATTYPE',
    'DISPID_SRGCommit', 'SPLOADOPTIONS', 'DISPID_SBSWrite',
    'ISpeechMemoryStream', 'SPCT_SUB_DICTATION', 'ISpeechRecoResult',
    'SPPS_SuppressWord', 'SpeechEmulationCompareFlags',
    'ISpeechVoiceStatus', 'SPEI_FALSE_RECOGNITION', 'DISPIDSPRG',
    'SpeechRecognitionType', 'DISPID_SFSClose',
    'DISPID_SRRAudioFormat', 'SAFTGSM610_11kHzMono', 'SPEI_UNDEFINED',
    'SPFILEMODE', 'SPBINARYGRAMMAR', 'SP_VISEME_3', 'SP_VISEME_15',
    'SpeechTokenKeyUI', 'DISPID_SREmulateRecognition',
    'DISPID_SGRSTType', 'SAFT16kHz16BitMono', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SOTsCount', 'ISpRecoResult', 'SpeechPartOfSpeech',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SRCVoice', 'SDTRule',
    'DISPID_SVIsUISupported', 'SAFTADPCM_11kHzMono',
    'DISPID_SDKCreateKey', 'DISPID_SLWsItem', 'SREBookmark', 'SVP_18',
    'SPEI_START_SR_STREAM', 'SINoise', 'SVEAudioLevel',
    'DISPID_SVDisplayUI', 'SREPropertyNumChange', 'SVSFPersistXML',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SPIReplacements',
    'DISPID_SBSRead', 'SPCS_DISABLED', 'DISPID_SPERequiredConfidence',
    'DISPID_SRProfile', 'ISpRecoContext', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SRCRecognizer', 'SpeechRuleState', 'ISpeechAudio',
    'SRTAutopause', 'eLEXTYPE_PRIVATE17', 'DISPID_SVEVoiceChange',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechAudioFormatGUIDWave',
    'DISPID_SPPValue', 'SAFTADPCM_8kHzMono', 'DISPID_SPPChildren',
    'SP_VISEME_13', 'SPRS_ACTIVE_USER_DELIMITED', 'SITooFast',
    'SpeechDictationTopicSpelling', 'SpeechEngineProperties',
    'SpTextSelectionInformation', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRCEInterference', 'SpeechLoadOption',
    'SDKLDefaultLocation', 'ISpeechMMSysAudio', 'eLEXTYPE_PRIVATE10',
    'DISPID_SPRsCount', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SAFTCCITT_ALaw_22kHzStereo', 'SAFTGSM610_44kHzMono',
    'DISPID_SMSALineId', 'SAFT22kHz16BitStereo',
    'DISPID_SpeechGrammarRuleStateTransitions', 'ISpeechVoice',
    'SPEI_END_INPUT_STREAM', 'SPRST_NUM_STATES',
    'DISPID_SLAddPronunciation', 'SpeechPropertyAdaptationOn',
    'DISPID_SOTId', 'eLEXTYPE_RESERVED9', 'ISpXMLRecoResult',
    'DISPID_SVGetAudioOutputs', 'SPFM_CREATE_ALWAYS', 'SpLexicon',
    'eLEXTYPE_PRIVATE4', 'SSFMCreateForWrite',
    'ISpeechPhraseReplacement', 'DISPID_SRCreateRecoContext',
    'SPVISEMES', 'SpeechAllElements', 'SINone', 'SECHighConfidence',
    'SPWORDLIST', 'SPPHRASEREPLACEMENT', 'ISpMMSysAudio',
    'eLEXTYPE_PRIVATE7', 'SpeechRegistryLocalMachineRoot',
    'SPEI_RESERVED6', 'SBONone', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPVPRI_OVER', 'SREAudioLevel', 'ISpeechPhraseProperty',
    'SREAdaptation', 'SRERequestUI', 'SpeechRecoContextState',
    'DISPID_SPEPronunciation', 'DISPID_SFSOpen', 'SPSHT_Unknown',
    'SPBO_PAUSE', 'LONG_PTR', 'SPEI_START_INPUT_STREAM',
    'ISpeechPhraseReplacements', 'SVSFDefault',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRCESoundEnd',
    'DISPID_SRRAudio', 'SPAO_RETAIN_AUDIO',
    'SSSPTRelativeToCurrentPosition', 'SPEI_PHRASE_START', 'SPPHRASE',
    'DISPID_SPPName', 'SpeechCategoryAudioOut',
    'SpeechVoiceSpeakFlags', 'UINT_PTR', 'SpPhoneConverter',
    'SPPS_Noun', 'ISpEventSink', 'DISPID_SDKGetStringValue',
    'DISPID_SPRText', 'DISPID_SPRuleId',
    'SpeechPropertyComplexResponseSpeed', 'SAFT48kHz16BitStereo',
    'DISPID_SRCEAdaptation', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SABIMinNotification', 'SGLexical', 'SPBOOKMARKOPTIONS',
    'SAFTADPCM_44kHzStereo', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SP_VISEME_12', 'SP_VISEME_6', 'DISPID_SVSLastStreamNumberQueued',
    'SFTInput', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'ISpStream', 'SpeechAudioProperties', 'IEnumSpObjectTokens',
    'ISpRecoGrammar', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SOTDataKey', 'SPSLMA', 'SDA_No_Trailing_Space',
    'DISPID_SRCBookmark', 'SpeechCategoryVoices',
    'SpeechPropertyResponseSpeed', 'DISPID_SGRSAddWordTransition',
    'SPFM_CREATE', 'SPRECOGNIZERSTATUS',
    'DISPID_SpeechAudioBufferInfo', 'SWTAdded', 'DISPID_SLPsItem',
    'DISPID_SRCEStartStream', 'SPPS_RESERVED3',
    'DISPID_SPPNumberOfElements', 'SPRECORESULTTIMES',
    'SPCT_DICTATION', 'SAFT11kHz16BitMono',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SPRuleParent',
    'SpMMAudioEnum', 'SpeechWordType', 'DISPID_SGRsCount',
    'SpeechGrammarTagDictation', 'DISPID_SRDisplayUI',
    'SGDSActiveWithAutoPause', 'eLEXTYPE_USER_SHORTCUT',
    'SP_VISEME_5', 'DISPID_SGRSTransitions', 'DISPID_SLPPartOfSpeech',
    'DISPID_SLWWord', 'ISpRecoGrammar2', 'DISPID_SWFEChannels',
    'DISPID_SGRsCommit', 'DISPID_SCSBaseStream', 'DISPID_SRGetFormat',
    'DISPID_SRCAudioInInterferenceStatus', 'SPSVerb',
    'DISPID_SRGCmdLoadFromFile', 'SPGRAMMARWORDTYPE',
    'SpeechTokenShellFolder', 'SRCS_Disabled', 'eLEXTYPE_RESERVED7',
    'DISPID_SpeechGrammarRules', 'SECFIgnoreWidth',
    'SpeechVoiceEvents', 'DISPID_SpeechPhraseBuilder', 'SDTProperty',
    'SVP_5', 'SAFT44kHz16BitStereo', 'DISPID_SRCEEndStream',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SpeechLexicon',
    'SPLO_DYNAMIC', 'DISPID_SRGId', 'SAFT11kHz8BitStereo',
    'DISPID_SpeechRecoContext', 'SVEViseme', 'DISPID_SMSADeviceId',
    'DISPID_SVSPhonemeId', 'SPAS_RUN', 'STCRemoteServer',
    'SpeechTokenIdUserLexicon', 'eLEXTYPE_PRIVATE9',
    'SPEI_VOICE_CHANGE', 'SSTTDictation', 'DISPID_SGRSTs_NewEnum',
    'SLOStatic', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SAFT22kHz16BitMono', 'DISPID_SVSInputWordPosition',
    'SPEI_RECOGNITION', 'SPFM_OPEN_READWRITE', 'SREInterference',
    'SRESoundStart', 'tagSPTEXTSELECTIONINFO', 'SRTStandard',
    'SPLO_STATIC', 'DISPID_SGRSTWeight', 'SVEAllEvents',
    'DISPID_SPRulesItem', 'eLEXTYPE_RESERVED8',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SpeechAudioFormat',
    'SPBO_TIME_UNITS', 'SVPAlert', 'DISPID_SPEs_NewEnum',
    'ISpProperties', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SAVolume', 'eLEXTYPE_APP', 'DISPID_SOTCId',
    'DISPID_SGRAddResource', 'SAFTNonStandardFormat',
    'DISPID_SRRTOffsetFromStart', 'SpWaveFormatEx',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SVEWord',
    'SGRSTTWildcard', 'SPEI_MAX_TTS', 'DISPID_SDKDeleteKey',
    'DISPIDSPTSI_ActiveOffset', 'SPCATEGORYTYPE', 'SPSHT_EMAIL',
    'SPWORDTYPE', 'eLEXTYPE_PRIVATE19',
    'DISPID_SVSInputSentencePosition', 'SPCS_ENABLED',
    'SPINTERFERENCE_TOOQUIET', 'SPVPRIORITY',
    'SPINTERFERENCE_TOOSLOW', 'SGSEnabled', 'SAFT12kHz8BitMono',
    'DISPID_SpeechObjectToken', 'DISPID_SRGDictationLoad',
    'SAFT32kHz8BitStereo', 'DISPID_SASFreeBufferSpace',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SPEAudioSizeBytes', 'SVP_0',
    'DISPID_SBSFormat', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SVSCurrentStreamNumber', 'SRSInactiveWithPurge',
    'DISPID_SRGCmdSetRuleState', 'SP_VISEME_18',
    'SpPhraseInfoBuilder', 'DISPID_SRSCurrentStreamPosition',
    'SDTAlternates', 'SBOPause', 'DISPID_SPIAudioSizeTime',
    'DISPID_SPPs_NewEnum', 'SpMemoryStream',
    'DISPID_SASCurrentDevicePosition', 'SGRSTTEpsilon',
    'SVEWordBoundary', 'DISPID_SpeechPhraseInfo', 'ISpSerializeState',
    'SAFT32kHz16BitMono', 'SpeechPropertyNormalConfidenceThreshold',
    'SpeechTokenKeyFiles', 'SAFT16kHz8BitMono', 'SPEI_WORD_BOUNDARY',
    'SGSDisabled', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SRCEEnginePrivate', 'SP_VISEME_17',
    'DISPID_SOTMatchesAttributes', 'ISpeechPhraseAlternate',
    'DISPID_SPCIdToPhone', 'SpeechVisemeType', 'SAFT24kHz16BitMono',
    'SPRST_INACTIVE_WITH_PURGE', 'SpObjectToken', 'SPRULE',
    'DISPID_SPAsItem', 'SPWT_LEXICAL', 'SpShortcut', 'SGRSTTWord',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SPIAudioStreamPosition',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SLWType',
    'SPCONTEXTSTATE', 'SVSFIsXML', 'DISPID_SOTCDefault',
    'SPWAVEFORMATTYPE', 'DISPID_SPAs_NewEnum', 'SpeechRunState',
    'SRAONone', 'SVSFIsNotXML', 'ISequentialStream',
    'SpeechVoiceSkipTypeSentence', 'SWPUnknownWordUnpronounceable',
    'DISPID_SOTDisplayUI', 'SSSPTRelativeToStart',
    'DISPID_SGRSTPropertyValue', 'SPLEXICONTYPE',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpPhraseAlt', 'SPWORD',
    'SpeechLexiconType', 'ISpeechGrammarRules',
    'DISPID_SRGetRecognizers', 'DISPID_SGRs_NewEnum', 'SVP_1',
    'eWORDTYPE_DELETED', 'SpMMAudioIn', 'DISPID_SVPause',
    'DISPID_SABIBufferSize', 'SpeechAudioFormatType',
    'DISPID_SOTGetDescription', 'SRSActive', 'SAFT48kHz16BitMono',
    'DISPID_SpeechPhraseReplacements', 'SVP_14',
    'DISPID_SRRGetXMLErrorInfo', 'SPSNoun',
    'ISpeechGrammarRuleStateTransitions', 'SVP_8',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SGRSTRule',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpInProcRecoContext', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'eLEXTYPE_RESERVED6', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFT8kHz16BitStereo', 'DISPID_SBSSeek', 'SPGS_DISABLED',
    'SPTEXTSELECTIONINFO', 'SPEI_REQUEST_UI',
    'DISPID_SRGSetTextSelection', 'SRSEIsSpeaking',
    'SAFTADPCM_22kHzMono', 'DISPID_SVAudioOutput',
    'DISPID_SpeechGrammarRule', 'SPEI_PHONEME',
    'DISPID_SVEStreamStart', 'SPAS_STOP', 'DISPID_SWFEAvgBytesPerSec',
    'SpeechStreamFileMode', 'SpeechPropertyLowConfidenceThreshold',
    'SSFMCreate', 'ISpeechLexiconPronunciations', 'SREStreamStart',
    'SREStateChange', 'DISPID_SGRSTsItem', 'DISPID_SRRTimes',
    'SPEI_SOUND_END', 'DISPID_SpeechVoice', 'ISpeechPhraseAlternates',
    'DISPID_SGRInitialState', 'eLEXTYPE_PRIVATE16',
    'DISPID_SRSCurrentStreamNumber', 'SPSEMANTICFORMAT',
    'DISPID_SRCSetAdaptationData', 'DISPID_SLPsCount',
    'DISPID_SAStatus', 'SGSExclusive', 'ISpNotifyTranslator',
    'ISpeechBaseStream', 'ISpObjectWithToken',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPIGrammarId',
    'DISPID_SGRSTNextState', 'DISPID_SMSGetData',
    'DISPID_SpeechWaveFormatEx', 'SPDKL_DefaultLocation', 'SVP_3',
    'DISPID_SWFEBlockAlign', 'SAFT8kHz8BitMono', 'SPRS_ACTIVE',
    'SRAInterpreter', 'SPAR_Unknown', 'SpResourceManager',
    'eLEXTYPE_PRIVATE8', 'DISPID_SRCCmdMaxAlternates',
    'SDKLLocalMachine', 'DISPID_SLPLangId', 'DISPID_SADefaultFormat',
    'DISPID_SLGetWords', 'DISPID_SWFEExtraData', 'DISPID_SGRsDynamic',
    'Speech_StreamPos_Asap', 'DISPID_SPIProperties',
    'SpeechAudioFormatGUIDText', 'SPPARTOFSPEECH', 'SPPROPERTYINFO',
    'DISPID_SPRNumberOfElements', 'SpSharedRecoContext',
    'ISpeechRecoContext', 'DISPID_SRRTLength', 'DISPID_SRGReset',
    'SVPOver', 'SPAUDIOSTATE',
    'DISPID_SpeechGrammarRuleStateTransition', 'WAVEFORMATEX',
    'DISPID_SWFEFormatTag', 'eLEXTYPE_PRIVATE20', 'DISPID_SVRate',
    'SVF_Emphasis', 'SDTLexicalForm', 'tagSPPROPERTYINFO',
    'SPRECOSTATE', 'SpeechAudioState', 'SRAImport', 'SP_VISEME_0',
    'SPEI_TTS_BOOKMARK', 'DISPID_SPPFirstElement', 'SGDisplay',
    'DISPID_SpeechPhraseElement', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPEEngineConfidence', 'SpeechWordPronounceable',
    'DISPID_SRSSupportedLanguages', 'SPXMLRESULTOPTIONS',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRSClsidEngine',
    'DISPID_SpeechCustomStream', 'IInternetSecurityMgrSite',
    'DISPID_SWFEBitsPerSample', 'SAFTCCITT_uLaw_44kHzStereo',
    'SpeechGrammarState', 'DISPID_SDKSetLongValue',
    'DISPID_SpeechRecoResult', 'eLEXTYPE_PRIVATE2',
    'DISPID_SRCEPhraseStart', 'SPGS_EXCLUSIVE', 'SGRSTTTextBuffer',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SRSAudioStatus',
    'SECFIgnoreKanaType', 'SSFMOpenReadWrite', 'SPINTERFERENCE',
    'SASClosed', 'SITooQuiet', 'DISPID_SLGetGenerationChange',
    'DISPID_SpeechLexiconPronunciation', 'SDA_Consume_Leading_Spaces',
    'SPCT_SUB_COMMAND', 'DISPID_SpeechBaseStream',
    'DISPID_SVPriority', 'SPPS_RESERVED2',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SRESoundEnd', 'SPEI_ADAPTATION',
    'SPEVENTENUM', 'ISpeechFileStream', 'SAFT8kHz16BitMono',
    'DISPID_SRIsUISupported', 'SPWT_PRONUNCIATION',
    'IInternetSecurityManager', 'SPXRO_SML', 'DISPID_SVSVisemeId',
    'SpeechDiscardType', 'DISPID_SPILanguageId',
    'DISPID_SpeechRecoResult2', 'DISPID_SRGRecoContext',
    'DISPID_SRCPause', 'SAFT48kHz8BitStereo',
    'SpeechEngineConfidence', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechBookmarkOptions', 'DISPID_SPACommit', 'IStream',
    'DISPID_SpeechRecognizerStatus', 'SAFT44kHz16BitMono',
    'SRAExport', 'DISPID_SPARecoResult',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'ISpPhoneticAlphabetConverter', 'SREPrivate',
    'DISPID_SpeechMMSysAudio', 'SAFT12kHz8BitStereo',
    'SDTReplacement', 'ISpeechPhraseRule', 'DISPID_SpeechRecognizer',
    'DISPID_SRGState', 'SPEI_SOUND_START', 'SPPS_Noncontent',
    'DISPID_SAFType', 'SP_VISEME_4', 'SPPHRASEPROPERTY',
    'SPEI_SR_PRIVATE', 'SAFT11kHz8BitMono', 'tagSTATSTG', 'SVP_7',
    'SPAUDIOSTATUS', 'DISPID_SpeechRecoContextEvents', 'SVEBookmark',
    'DISPID_SOTIsUISupported', 'SAFTText', 'ISpResourceManager',
    'DISPID_SDKSetBinaryValue', 'SECFNoSpecialChars',
    'SpeechTokenValueCLSID', 'DISPID_SRAudioInput',
    'SAFTNoAssignedFormat', 'SpCustomStream', 'SRTSMLTimeout',
    'SPPS_NotOverriden', 'DISPID_SpeechAudioStatus', 'SVP_13',
    'ISpeechLexiconPronunciation', 'SPRECOCONTEXTSTATUS',
    '__MIDL_IWinTypes_0009', 'SAFT22kHz8BitStereo',
    'SpNotifyTranslator', 'DISPID_SVSInputWordLength',
    'ISpeechRecognizerStatus', 'ISpeechRecoResultDispatch',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SVSpeakStream',
    'SPSUnknown', 'DISPID_SRGDictationSetState', 'ISpLexicon',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SVSInputSentenceLength', 'SVP_19', 'DISPID_SDKEnumKeys',
    'SRERecoOtherContext', 'SPSFunction', 'SAFT32kHz8BitMono',
    'ISpeechPhraseInfoBuilder', 'SpeechPropertyResourceUsage',
    'DISPID_SVVolume', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SRCEHypothesis', 'ISpRecognizer3', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SMSSetData', 'SPSHT_OTHER', 'SPEI_RESERVED2',
    'ISpNotifySource', 'SPDATAKEYLOCATION', 'DISPID_SVResume',
    'SP_VISEME_10', 'SVF_Stressed', 'DISPID_SASState', 'SVF_None',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SLPs_NewEnum',
    'DISPID_SPPsCount', 'DISPID_SGRSRule',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRGCmdLoadFromObject', 'SAFT32kHz16BitStereo',
    'SPSHT_NotOverriden', 'STSF_CommonAppData', 'SGRSTTDictation',
    'SP_VISEME_11', 'ISpeechGrammarRuleState', 'DISPID_SOTCSetId',
    'DISPID_SPEActualConfidence', 'DISPID_SRSNumberOfActiveRules',
    'SDKLCurrentConfig', 'DISPID_SVEventInterests',
    'DISPID_SVEEnginePrivate', 'SAFTGSM610_22kHzMono',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SPIGetText',
    'Speech_Max_Pron_Length', 'SLTUser', 'SAFT8kHz8BitStereo',
    'SVP_2', 'ISpeechPhraseInfo', 'SRTReSent', 'DISPID_SVStatus',
    'DISPID_SpeechPhraseAlternate', 'SPINTERFERENCE_TOOFAST',
    'SINoSignal', 'SECLowConfidence', 'DISPID_SOTsItem',
    'DISPID_SPPConfidence', 'ISpRecoContext2',
    'DISPID_SpeechPhraseElements', 'SPEI_INTERFERENCE', 'SVEPrivate',
    'DISPID_SDKGetBinaryValue', 'eLEXTYPE_RESERVED10',
    'DISPID_SABufferInfo', 'DISPID_SPRDisplayAttributes', 'STCAll',
    'STCInprocServer', 'SAFTCCITT_ALaw_44kHzMono',
    'SPEVENTSOURCEINFO', 'SGRSTTRule', 'SGDSActive',
    'SpeechVoicePriority', 'SPEI_END_SR_STREAM',
    'DISPID_SPEDisplayText', 'DISPID_SRGetPropertyString',
    'SPSERIALIZEDPHRASE', 'SVP_9', 'eLEXTYPE_PRIVATE18',
    'SPEI_RESERVED3', 'DISPID_SRGDictationUnload', 'SPBO_AHEAD',
    'DISPID_SPRFirstElement', 'eLEXTYPE_PRIVATE3',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVPNormal',
    'SpeechPropertyHighConfidenceThreshold', 'SPEI_TTS_PRIVATE',
    'DISPID_SRCEBookmark', 'SPDKL_LocalMachine',
    'DISPID_SRCERecognizerStateChange', 'SSSPTRelativeToEnd',
    'DISPID_SRCEventInterests', 'SpeechCategoryPhoneConverters',
    'DISPID_SASCurrentSeekPosition', 'SPRS_INACTIVE',
    'SpStreamFormatConverter', 'SSFMOpenForRead',
    'DISPID_SpeechXMLRecoResult', 'SVP_11', 'SAFT24kHz8BitMono',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SGRSTPropertyId',
    'DISPID_SRCEFalseRecognition', 'SLTApp',
    '_ISpeechRecoContextEvents', 'SPPHRASERULE',
    'DISPID_SWFESamplesPerSec', 'SPPS_Verb', 'SRARoot',
    'SpeechGrammarRuleStateTransitionType', 'SP_VISEME_2',
    'DISPID_SLPType', '_SPAUDIOSTATE', 'SWPKnownWordPronounceable',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPBO_NONE',
    'DISPID_SPISaveToMemory', 'DISPID_SOTRemove',
    'DISPID_SRCEAudioLevel', 'DISPIDSPTSI', 'SREHypothesis',
    'STSF_AppData', 'SPADAPTATIONRELEVANCE', 'DISPID_SLPPhoneIds',
    'SRSInactive', 'SPSERIALIZEDRESULT', 'DISPID_SpeechAudio',
    'SpeechDataKeyLocation', 'SPCT_SLEEP', 'ISpeechLexiconWord',
    'DISPID_SRStatus', 'SPINTERFERENCE_NONE', 'SPEI_MAX_SR',
    'SASStop', 'DISPID_SRCRetainedAudioFormat', 'DISPID_SDKOpenKey',
    'Speech_Max_Word_Length', 'DISPID_SpeechPhraseProperties',
    'DISPID_SVESentenceBoundary', 'SPEI_MIN_TTS',
    'ISpeechPhraseProperties', 'SpeechCategoryRecoProfiles',
    'DISPID_SOTs_NewEnum', 'SAFTCCITT_uLaw_44kHzMono', 'SPAS_CLOSED',
    'DISPID_SPRuleName', 'DISPID_SPAStartElementInResult',
    'eWORDTYPE_ADDED', 'DISPID_SPEAudioStreamOffset',
    'SPSNotOverriden', 'SP_VISEME_19', 'DISPID_SpeechPhraseRules',
    'DISPID_SVSLastResult', 'SVSFNLPMask', 'ISpPhrase',
    'DISPID_SRState', 'DISPID_SRSetPropertyNumber', 'DISPID_SPIRule',
    'eLEXTYPE_PRIVATE6', 'SPEI_VISEME',
    'SpeechStreamSeekPositionType', 'DISPID_SpeechMemoryStream',
    'DISPID_SLPSymbolic', 'SPWF_SRENGINE', 'SDTDisplayText',
    'SAFTADPCM_44kHzMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SGRSAddRuleTransition', 'ISpStreamFormatConverter',
    'SPSEMANTICERRORINFO', 'SpInprocRecognizer', 'SGDSInactive',
    'SPAR_Medium', 'DISPID_SPEAudioSizeTime', '_RemotableHandle',
    'Speech_StreamPos_RealTime', 'SpFileStream', 'SREPhraseStart',
    'ISpRecognizer2', 'SITooLoud', 'SVEVoiceChange', 'ISpNotifySink',
    'DISPID_SRCERecognition', 'DISPID_SLWLangId',
    'SVSFParseAutodetect', 'SAFT11kHz16BitStereo',
    'DISPID_SLWs_NewEnum', 'SpeechVisemeFeature',
    'DISPID_SPRs_NewEnum', 'DISPID_SVSkip', 'SPAR_Low', 'SVP_16',
    'DISPID_SPIEngineId', 'SPCT_COMMAND', 'SpeechCategoryAudioIn',
    'SECFEmulateResult', 'DISPID_SGRClear', 'DISPID_SVSLastBookmark',
    'DISPID_SASNonBlockingIO', 'SVSFUnusedFlags',
    '_ISpeechVoiceEvents', 'ISpeechResourceLoader',
    'DISPID_SRSetPropertyString', 'DISPID_SOTCategory', 'SVP_4',
    'DISPIDSPTSI_SelectionLength', 'SVSFParseMask',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SRCESoundStart',
    'SPAO_NONE', 'SPSHORTCUTTYPE', 'SRERecognition', 'SpMMAudioOut',
    'DISPID_SPRulesCount', 'DISPID_SRRRecoContext', 'SDKLCurrentUser'
]
